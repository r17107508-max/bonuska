...
- Глобальный админ: `79176154920` / `grUpPGSmz2111`
...
Актуальные редакции договора-оферты, политики персональных данных и платежных реквизитов хранятся в `src/lib/service-documents.json` и применяются при заполнении настроек сервиса.
