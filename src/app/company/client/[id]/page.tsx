...
import { KpiCard, StatusPill, WorkspaceCard } from "@/components/company-ui";
          ...
          <WorkspaceCard className="border-[rgba(201,71,38,0.25)] bg-[var(--brand-soft)]">
            <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
              <div>
                ...
                <p className="mt-1 text-sm text-[var(--text-muted)]">{membership.user.phone}</p>
        ...
        <aside className="space-y-4">
          <WorkspaceCard>
            ...
            <div className="mt-4 space-y-3 text-sm text-[var(--text-muted)]">
              <p><span className="font-bold text-[var(--text)]">Телефон:</span> {membership.user.phone}</p>
              ...
              <p className="break-all"><span className="font-bold text-[var(--text)]">QR-токен:</span> tega:{membership.qrToken}</p>
            </div>
          </WorkspaceCard>
