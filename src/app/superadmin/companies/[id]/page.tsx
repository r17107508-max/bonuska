...
function emailAuditLabel(action: string) {
  const labels: Record<string, string> = {
    ...
    EMAIL_COMPANY_APPLICATION_RECEIVED_SENT: "Компании отправлено письмо о получении заявки",
    EMAIL_COMPANY_APPLICATION_RECEIVED_SKIPPED: "Письмо компании о получении заявки не отправлено",
    EMAIL_COMPANY_APPLICATION_RECEIVED_FAILED: "Ошибка письма компании о получении заявки",
